...
WebUI.selectOptionByLabel(findTestObject('AMS/5flightPage/20QuotesComplete/addNewQuote/operator_dropDown'), operator3, false)

WebUI.selectOptionByLabel(findTestObject('AMS/5flightPage/20QuotesComplete/addNewQuote/aircraft_dropDown'), aircraft3, false)

WebUI.selectOptionByLabel(findTestObject('AMS/5flightPage/20QuotesComplete/addNewQuote/quoteType_dropDown'), quoteType3, 
    false)

WebUI.setText(findTestObject('AMS/5flightPage/20QuotesComplete/addNewQuote/operatorQuote_textBox'), operatorQuote3)

WebUI.click(findTestObject('AMS/5flightPage/20QuotesComplete/addNewQuote/save_button'))

WebUI.click(findTestObject('AMS/5flightPage/20QuotesComplete/groupQuote/addQuoteGroup_button'))

WebUI.click(findTestObject('AMS/5flightPage/20QuotesComplete/groupQuote/leg1_checkBox'))

WebUI.click(findTestObject('AMS/5flightPage/20QuotesComplete/groupQuote/leg2_checkBox'))

WebUI.click(findTestObject('AMS/5flightPage/20QuotesComplete/groupQuote/leg3_checkBox'))
