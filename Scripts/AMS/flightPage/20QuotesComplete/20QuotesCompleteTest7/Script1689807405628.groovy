...
WebUI.click(findTestObject('AMS/5flightPage/20QuotesComplete/tripQuote/apply_button'))

WebUI.click(findTestObject('AMS/5flightPage/20QuotesComplete/tripQuote/yesApply_button'))

WebUI.verifyTextPresent(billTime, false)

WebUI.verifyTextPresent(memberPrice, false)

WebUI.verifyTextPresent(revenue, false)

WebUI.verifyTextPresent(operatorQuote, false)

WebUI.verifyTextPresent(pl, false)
