...
WebUI.scrollToElement(findTestObject('AMS/5flightPage/addNewFlight/multiLeg_checkBox'), 30)

WebUI.click(findTestObject('AMS/5flightPage/addNewFlight/multiLeg_checkBox'))

WebUI.click(findTestObject('AMS/5flightPage/addNewFlight/plusSign_button'))
...
WebUI.setText(findTestObject('AMS/5flightPage/addNewFlight/fromLeg2_textBox'), fromLeg2)

WebUI.setText(findTestObject('AMS/5flightPage/addNewFlight/toLeg2_textBox'), toLeg2)

WebUI.setText(findTestObject('AMS/5flightPage/addNewFlight/fromLeg3_textBox'), fromLeg3)

WebUI.setText(findTestObject('AMS/5flightPage/addNewFlight/toLeg3_textBox'), toLeg3)
...
WebUI.setText(findTestObject('AMS/5flightPage/addNewFlight/dateLeg3_textBox'), dateLeg3)

WebUI.setText(findTestObject('AMS/5flightPage/addNewFlight/timeLeg3_textBox'), timeLeg3)
...
WebUI.setText(findTestObject('AMS/5flightPage/addNewFlight/paxLeg3_textBox'), paxLeg3)
