...
WebUI.scrollToElement(findTestObject('AMS/5flightPage/pricingAndDocuments/pricingAndDocuments_tab'), 30)
...
WebUI.click(findTestObject('AMS/5flightPage/pricingAndDocuments/edit/closeEditConfirmedFlight_button'))
