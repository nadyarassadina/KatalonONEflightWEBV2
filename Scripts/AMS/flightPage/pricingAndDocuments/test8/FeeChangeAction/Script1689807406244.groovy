...
WebUI.selectOptionByLabel(findTestObject('AMS/5flightPage/pricingAndDocuments/edit/selectAdjustment_dropDown'), selectAdjustment, 
    false)

WebUI.setText(findTestObject('AMS/5flightPage/pricingAndDocuments/edit/description_textBox'), description)

WebUI.setText(findTestObject('AMS/5flightPage/pricingAndDocuments/edit/amount_textBox'), amount)

WebUI.setText(findTestObject('AMS/5flightPage/pricingAndDocuments/edit/leg1/from_textBox'), departureAirportLeg1)

WebUI.click(findTestObject('AMS/5flightPage/pricingAndDocuments/edit/leg1/date_textBox'))

WebUI.setText(findTestObject('AMS/5flightPage/pricingAndDocuments/edit/leg2/to_textBox'), destinationAirportLeg2)
...
WebUI.setText(findTestObject('AMS/5flightPage/pricingAndDocuments/edit/Page_Client Detail/fuelStop2Leg1'), fuelStop2Leg1)
