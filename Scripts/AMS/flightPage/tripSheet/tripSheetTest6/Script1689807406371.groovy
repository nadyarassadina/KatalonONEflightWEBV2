...
WebUI.scrollToElement(findTestObject('AMS/5flightPage/tripSheet/arriveLeg2_value'), 30)

WebUI.verifyTextPresent(arriveLeg2, false)

WebUI.scrollToElement(findTestObject('AMS/5flightPage/tripSheet/arriveLeg3_value'), 30)

WebUI.verifyTextPresent(arriveLeg3, false)

WebUI.scrollToElement(findTestObject('AMS/5flightPage/tripSheet/passenger1Leg1_value'), 30)

WebUI.verifyTextPresent(passenger1Leg1, false)

WebUI.scrollToElement(findTestObject('AMS/5flightPage/tripSheet/passenger1Leg2_value'), 30)

WebUI.verifyTextPresent(passenger1Leg2, false)

WebUI.scrollToElement(findTestObject('AMS/5flightPage/tripSheet/passenger1Leg3_value'), 30)

WebUI.verifyTextPresent(passenger1Leg3, false)
