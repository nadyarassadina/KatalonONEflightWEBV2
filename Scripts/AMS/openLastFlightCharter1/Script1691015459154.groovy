...
WebUI.setText(findTestObject('AMS/3homePage/searchHomePage_field'), 'CharterCL')

WebUI.click(findTestObject('AMS/3homePage/goHomePage_button'))

WebUI.click(findTestObject('AMS/4searchClientFlights/charter/chartercl1Katalon_object'))
