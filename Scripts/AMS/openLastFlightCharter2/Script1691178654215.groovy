...
WebUI.setText(findTestObject('AMS/3homePage/searchHomePage_field'), 'CharterCL2')

WebUI.click(findTestObject('AMS/3homePage/goHomePage_button'))

WebUI.click(findTestObject('AMS/4searchClientFlights/charter/Page_Client Search/chartercl2Katalon_object'))
