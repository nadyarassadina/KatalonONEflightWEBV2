...
WebUI.click(findTestObject('BAJit/flightSearch/add2_button'))

WebUI.setText(findTestObject('BAJit/flightSearch/departureAirportLeg3_textBox'), departureAirport3)

WebUI.setText(findTestObject('BAJit/flightSearch/destinationAirportLeg3_textBox'), destinationAirport3)

WebUI.setText(findTestObject('BAJit/flightSearch/departureDateLeg3_textBox'), date3)
