...
WebUI.verifyTextPresent(billedFlightTimeLeg3, false)
...
WebUI.verifyTextPresent(priorityBookingCharge, false)

WebUI.verifyTextPresent(subtotal, false)

WebUI.verifyTextPresent(federalExiseTax, false)

WebUI.verifyTextPresent(usSegmentTax, false)

WebUI.verifyTextPresent(usTransportationTax, false)

WebUI.verifyTextPresent(convenienceCC, false)

WebUI.verifyTextPresent(totalDue, false)
