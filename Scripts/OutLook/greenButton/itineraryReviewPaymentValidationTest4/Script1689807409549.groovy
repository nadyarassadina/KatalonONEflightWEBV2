...
WebUI.verifyTextPresent('Cannot Book Trip - Account does not have sufficient funds.', false)

WebUI.click(findTestObject('greenButton/itineraryReviewPayment/Page_Proceed to Payment - ONEflight/clETest4_button'))
